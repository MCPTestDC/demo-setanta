...
class Recipe(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "description", "user_id", "ingredients"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "ingredients": [Ingredient.from_dict(_item) for _item in obj.get("ingredients")] if obj.get("ingredients") is not None else None
        })
        return _obj
